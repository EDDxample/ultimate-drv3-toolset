...
def read(filename):
    ...
    with open(f'files/srd/{filename}', 'rb') as f:
        filength = os.stat(f'files/srd/{filename}').st_size
        while f.tell() < filength:
            ...
            if   magic == '$CFH': pass
                ...
                font_pic_data['width'] = display_width
                font_pic_data['height'] = display_height
                ...
                get_bb_positions(f, character_count)
